...
const LUXURY_DESTINATIONS: Record<string, {
  ...
  'Abu Dhabi': { desc: '沙漠中的文化绿洲。卢浮宫阿布扎比、谢赫扎耶德大清真寺与F1赛道。', bestTime: '11月-3月', visa: '免签/30天', priceBase: 108000, days: 5 },
  'Petra': { desc: '玫瑰古城。世界新七大奇迹之一，佩特拉之夜的烛光与瓦迪拉姆沙漠星空营地。', bestTime: '3月-5月', visa: '电子签', priceBase: 118000, days: 7 },
  'Rajasthan': { desc: '印度的皇家之心。斋浦尔粉红之城、乌代浦尔湖宫、焦特布尔蓝色之城与骆驼节。', bestTime: '10月-3月', visa: '电子签', priceBase: 98000, days: 9 },
  'Goa': { desc: '印度的葡萄牙殖民遗风。椰林海滩、香料种植园、殖民教堂与瑜伽静修。', bestTime: '11月-2月', visa: '电子签', priceBase: 78000, days: 7 },
  'Sri Lanka': { desc: '印度洋的眼泪。锡兰茶园、狮子岩、加勒古堡与雅拉国家公园花豹追踪。', bestTime: '12月-3月', visa: '电子签', priceBase: 88000, days: 8 },
  'Luang Prabang': { desc: '琅勃拉邦的清晨布施。金顶寺庙、湄公河游船、光西瀑布与法式殖民风情。', bestTime: '11月-4月', visa: '落地签', priceBase: 68000, days: 6 },
  'Bagan': { desc: '万千佛塔之城。热气球日出、蒲甘王朝遗迹、伊洛瓦底江游船与漆器工坊。', bestTime: '11月-3月', visa: '电子签', priceBase: 78000, days: 7 },
  'Samarkand': { desc: '丝绸之路上的蓝色明珠。雷吉斯坦广场、帖木儿陵墓、手工地毯与中亚美食。', bestTime: '4月-6月', visa: '电子签', priceBase: 88000, days: 7 },
  'Fiji': { desc: '南太平洋的天堂群岛。私人岛屿度假村、珊瑚礁潜水、卡瓦仪式与日落巡航。', bestTime: '5月-10月', visa: '免签/120天', priceBase: 178000, days: 9 },
  'Tahiti': { desc: '法属波利尼西亚的梦幻之境。水上屋发源地、波拉波拉岛、黑珍珠与法式美食。', bestTime: '5月-10月', visa: '免签/90天', priceBase: 198000, days: 10 },
  'Costa Rica': { desc: '中美洲的生态天堂。云雾森林、树懒栖息地、火山温泉与世界级冲浪。', bestTime: '12月-4月', visa: '免签/90天', priceBase: 128000, days: 8 },
  'Galápagos': { desc: '达尔文的活教室。巨龟、蓝脚鲣鸟、海鬣达尔文的活教室。巨龟、蓝脚鲣鸟、海鬣蜥与潜水看锤头鲨。', bestTime: '6月-9月', visa: '免签/90天', priceBase: 198000, days: 10 },
  'Santiago': { desc: '智利的葡萄酒之都。安第斯山脉、中央市场海鲜、瓦尔帕莱索彩色小屋。', bestTime: '10月-4月', visa: '免签/90天', priceBase: 128000, days: 8 },
  'Cartagena': { desc: '加勒比海的殖民古城。彩色建筑、城墙漫步、罗萨里奥群岛与哥伦比亚咖啡。', bestTime: '12月-4月', visa: '免签/90天', priceBase: 108000, days: 7 },
  'Serengeti': { desc: '非洲大草原的生命史诗。百万角马大迁徙、热气球Safari、恩戈罗恩戈罗火山口。', bestTime: '6月-10月', visa: '电子签', priceBase: 188000, days: 10 },
  'Victoria Falls': { desc: '雷鸣之烟。世界最大瀑布、蹦极发源地、赞比西河日落巡航与直升机俯瞰。', bestTime: '2月-5月', visa: '电子签', priceBase: 148000, days: 8 },
  'Madagascar': { desc: '第八大洲。狐猴王国、猴面包树大道、琥珀山国家公园与诺西贝岛海滩。', bestTime: '4月-11月', visa: '电子签', priceBase: 138000, days: 10 },
  'Budapest': { desc: '多瑙河上的明珠。塞切尼温泉、渔人堡、匈牙利美食与废墟酒吧文化。', bestTime: '4月-10月', visa: '申根签证', priceBase: 98000, days: 6 },
  'Berlin': { desc: '欧洲的创意之都。柏林墙遗址、博物馆岛、电子音乐与多元美食文化。', bestTime: '5月-9月', visa: '申根签证', priceBase: 108000, days: 6 },
  'Stockholm': { desc: '北欧威尼斯。瓦萨沉船博物馆、老城Gamla Stan、诺贝尔奖晚宴与设计之都。', bestTime: '6月-8月', visa: '申根签证', priceBase: 128000, days: 6 },
  'Copenhagen': { desc: '幸福之都。新港彩色小屋、Tivoli乐园、Noma餐厅发源地与自行车文化。', bestTime: '5月-9月', visa: '申根签证', priceBase: 118000, days: 5 },
  'Helsinki': { desc: '波罗的海的设计之都。芬兰桑姆、设计区、岩石教堂与圣诞老人村。', bestTime: '6月-8月', visa: '申根签证', priceBase: 118000, days: 5 },
  'Munich': { desc: '巴伐利亚的骄傲。新天鹅堡、啤酒花园、宝马博物馆与阿尔卑斯山门户。', bestTime: '5月-10月', visa: '申根签证', priceBase: 118000, days: 6 },
  'Milan': { desc: '时尚之都。米兰大教堂、达芬奇《最后的晚餐》、蒙特拿破仑大街与意大利烩饭。', bestTime: '4月-6月', visa: '申根签证', priceBase: 118000, days: 6 },
  'Madrid': { desc: '伊比利亚之心。普拉多博物馆、马德里王宫、火腿博物馆与弗拉门戈舞。', bestTime: '3月-5月', visa: '申根签证', priceBase: 108000, days: 6 },
  'Dublin': { desc: '翡翠岛的文学之城。健力士啤酒厂、三一学院、莫赫悬崖与爱尔兰音乐酒吧。', bestTime: '5月-9月', visa: '英国签证', priceBase: 118000, days: 6 },
};
...
async function main() {
  ...
  const hubConnected = [
    ...
    { city: 'Abu Dhabi', via: 'Dubai', origin: '上海', price: 108000, days: 5 },
    { city: 'Petra', via: 'Istanbul', origin: '北京', price: 138000, days: 9 },
    { city: 'Rajasthan', via: 'Singapore', origin: '上海', price: 128000, days: 11 },
    { city: 'Goa', via: 'Singapore', origin: '广州', price: 98000, days: 9 },
    { city: 'Sri Lanka', via: 'Singapore', origin: '上海', price: 108000, days: 10 },
    { city: 'Luang Prabang', via: 'Bangkok', origin: '广州', price: 88000, days: 8 },
    { city: 'Bagan', via: 'Bangkok', origin: '广州', price: 98000, days: 9 },
    { city: 'Samarkand', via: 'Istanbul', origin: '北京', price: 118000, days: 9 },
    { city: 'Fiji', via: 'Sydney', origin: '上海', price: 198000, days: 11 },
    { city: 'Tahiti', via: 'Sydney', origin: '上海', price: 218000, days: 12 },
    { city: 'Costa Rica', via: 'New York', origin: '北京', price: 168000, days: 10 },
    { city: 'Galápagos', via: 'Lima', origin: '上海', price: 218000, days: 12 },
    { city: 'Santiago', via: 'Lima', origin: '上海', price: 168000, days: 10 },
    { city: 'Cartagena', via: 'New York', origin: '北京', price: 158000, days: 9 },
    { city: 'Serengeti', via: 'Nairobi', origin: '上海', price: 198000, days: 12 },
    { city: 'Victoria Falls', via: 'Cape Town', origin: '上海', price: 178000, days: 10 },
    { city: 'Madagascar', via: 'Dubai', origin: '上海', price: 178000, days: 12 },
    { city: 'Budapest', via: 'Vienna', origin: '北京', price: 118000, days: 8 },
    { city: 'Berlin', via: 'Amsterdam', origin: '上海', price: 128000, days: 8 },
    { city: 'Munich', via: 'Zurich', origin: '北京', price: 128000, days: 8 },
    { city: 'Stockholm', via: 'Oslo', origin: '上海', price: 138000, days: 8 },
    { city: 'Copenhagen', via: 'Amsterdam', origin: '上海', price: 128000, days: 7 },
    { city: 'Helsinki', via: 'Stockholm', origin: '北京', price: 128000, days: 7 },
    { city: 'Milan', via: 'Rome', origin: '上海', price: 128000, days: 8 },
    { city: 'Madrid', via: 'Barcelona', origin: '上海', price: 128000, days: 8 },
    { city: 'Dublin', via: 'London', origin: '上海', price: 138000, days: 8 },
  ];
