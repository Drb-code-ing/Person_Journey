            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              {faqSections.map((section, i) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  transition={{ duration: 0.4, ease: goldEase }}
                  className={`relative px-12 py-[18px] rounded-2xl text-[15px] tracking-wide font-medium transition-colors duration-300 ${
                    activeSection === i
              ...
              >
                ...
                >
                  <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.97 }}>
                    <Link
                      href="/booking"
                      className="group inline-flex items-center gap-3 px-16 py-[22px] bg-[#2c2a27] text-[#f3ebe4] font-medium rounded-2xl hover:bg-[#C9A96E] transition-all duration-500 text-[16px] tracking-wide shadow-[0_4px_20px_rgba(44,42,39,0.12)] hover:shadow-[0_6px_30px_rgba(201,169,110,0.2)]"
                    >
                      开始预订
                  ...
                  <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.97 }}>
                    <a
                      ...
                      className="inline-flex items-center gap-3 px-16 py-[22px] bg-white/40 border border-[#e8e4de]/80 text-[#2c2a27] font-medium rounded-2xl hover:border-[#C9A96E]/30 hover:text-[#C9A96E] hover:bg-white/50 hover:shadow-[0_4px_20px_rgba(201,169,110,0.08)] transition-all duration-500 text-[16px] tracking-wide"
                    >
                      <Phone size={16} />
                      致电咨询
                    </a>
